...
public class WakeupProcess extends JFrame {
    private JTextField processIdTextField;
    private JTable processDetailsTable;
    private DefaultTableModel tableModel;

    public WakeupProcess() {
        initComponents();
    }

    private void initComponents() {
        // Set up the frame
        setTitle("Wakeup a Process");
        setSize(600, 400);
        ...
        wakeupButton.setPreferredSize(new Dimension(80, 30)); // Set button size
        ...
        inputPanel.add(new JLabel("Enter Process ID to wakeup:"));
        inputPanel.add(processIdTextField);
        inputPanel.add(wakeupButton);
        ...
        wakeupButton.addActionListener(e -> wakeupProcess());
    }
    ...
    private void wakeupProcess() {
        ...
        JOptionPane.showMessageDialog(this, "Process with ID " + processId + " woken up.", "Process Woken Up", JOptionPane.INFORMATION_MESSAGE);
